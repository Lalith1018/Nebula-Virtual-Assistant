...
class Widget():
    ...
    #------------------------------------------------------KEY WORD LISTS---------------------------------------------------------------------------
    #                THESE ARE ALL THE LIST WHICH CONTAINS IMPORTANT KEYWORDS WHICH THE Nebula CAN USE.
    #--------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    name = ['You Can call me Nebula','My Name Is Nebula','you named me Nebula','You Should Know this, My name Is Nebula']
    ...
    #---------------------------PRINTING FUNC---------------------------------------------------
    #       THIS FUCTION PRINTS THE Nebula'S RESPONCE TO SCREEN.
    #---------------------------------------------------------------------------------------------------
    ...
    #-----------------SPEAK FUNCTION-------------------------------
    #    THIS FUNCTION SPEAKS THE Nebula'S RESPONCE
    #------------------------------------------------------------------------
    def speak(self,s):
        self.engine.say(s)
    ...
    #-----------------------SEND FUNC-----------------------------------------------------------------
    #        THIS FUCTION IS BEING USED TO SEND USER_INPUT TO Nebula.
    #--------------------------------------------------------------------------------------------------------
    def send_func(self):
    ...
    #-------------------------------------------------------------------------------------------------------
        ...
        #------------------------------------CONDITIONS------------------------------------------------------------------------------------------
        # THESE ARE CONDITIONS WHICH THE Nebula CHECKS. HE RESPOND TO THE MOST RELEVENT CONDITION.
        #-------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        #-----------------GURPARTAP CONDITION-------------------------------------------------------------------
        elif 'nebula'  in user_input:
            out = 'Nebula Is A Good Friend Of Aditya. He Is Well Known As Nebula.'                                                                                               #|   
            self.printing_func(out)                                                                                    #|
            self.speak(out)
        #-----------------------------------------------------------------------------------------------------------------------
    ...
    def __init__(self):
        ...
        Label(self.win, text='Nebula' , font=('arial black',20),fg='white',bg='orange').place(x=260,y=50)
